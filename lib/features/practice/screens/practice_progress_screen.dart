...
class _PracticeProgressScreenState extends State<PracticeProgressScreen> {
  ...
  Widget _streakHero(bool dark) => Container(
        ...
        child: Row(children: [
          ...
          Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            ...
            Text(_streak == 0 ? 'Start today to build your streak.' : 'Keep today’s Practice habit alive.', style: TextStyle(color: AppColors.primary, fontWeight: FontWeight.w800)),
          ])),
        ]),
      );
  ...
  Widget _calendar(bool dark) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(color: dark ? AppColors.cardDark : Colors.white, borderRadius: BorderRadius.circular(20), border: Border.all(color: dark ? AppColors.borderDark : AppColors.borderLight)),
      child: Column(children: [
        ...
        GridView.builder(
          ...
          itemBuilder: (_, index) {
            ...
            return Container(
              decoration: BoxDecoration(color: practiced ? AppColors.primary.withValues(alpha: .16) : Colors.transparent, shape: BoxShape.circle, border: today ? Border.all(color: AppColors.primary, width: 1.5) : null),
              child: Center(child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [Text('$dayNumber', style: TextStyle(fontWeight: practiced ? FontWeight.w900 : FontWeight.w600)), if (practiced) const Icon(Icons.check_rounded, size: 11, color: AppColors.primary)])),
            );
          },
        ),
      ]),
  ...
  Widget _badgesSection(bool dark) => Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        ..._badges.map((badge) => Container(
              ...
              decoration: BoxDecoration(color: dark ? AppColors.cardDark : Colors.white, borderRadius: BorderRadius.circular(16), border: Border.all(color: badge.unlocked ? AppColors.primary.withValues(alpha: .35) : (dark ? AppColors.borderDark : AppColors.borderLight))),
              child: Row(children: [
                ...
                Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  ...
                  if (!badge.unlocked) ...[
                    ...
                    LinearProgressIndicator(value: badge.target <= 1 ? badge.progress.toDouble().clamp(0, 1) : badge.progress / badge.target, minHeight: 5),
                  ],
                ])),
